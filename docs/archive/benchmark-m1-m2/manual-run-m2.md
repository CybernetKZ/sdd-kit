...
Подготовка: `! bash /home/octrow/cybernet/sdd-kit/benchmark/archive-m1-m2/prepare-m2.sh`
Снапшот: `/home/octrow/cybernet/refactor_v4/logs/prep-m2-snapshot.txt` (SHA заполняется скриптом).
