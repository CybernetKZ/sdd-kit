...
Статус: волны 0–5 выполнены 2026-08-04; остался dry-run (репо не выбран) и
кандидат `patch2change.md` (строка про ТЗ №33 — править при доступе к
`docs/patches/` conversation_flow). Пробел ADR-0017 в grounding-таблице закрыт
на волне 5.
