...
- **эпик** - один change, несколько маленьких PR за флагом (ADR-0011). Помечается в тикете на intake; подозревать эпик, когда план предсказывает >1500 строк или >2 дней на один PR - уточнить у автора (ADR-0012).
