...
Legend: ✅ yes · ⚠️ partial/needs config · ❌ no. Stars/licenses per GitHub as observed July 30, 2026 (fluctuate).
...
|-----------------------------------------------------|-------------------|---------------------------------------------|-----------------------|---------------------|------------------------|-------------------|--------------------|--------------------|---------------------------------------------|------------------------------|-----------------------------|-----------------------------------------------|------------------------------------------------------|----------------------------------------------|
| **Langfuse** (langfuse/langfuse)                    | ✅                 | ✅                                           | ✅                     | ⚠️ (usage detail)   | ⚠️ spans               | ⚠️ spans          | ❌                  | ✅                  | ⚠️ via LiteLLM/SDK                          | ✅                            | ⚠️ annotation queues        | ~27,200                                       | MIT (except `ee/`)                                   | active 2026                                  |
| **Arize Phoenix** (Arize-ai/phoenix)                | ✅                 | ✅                                           | ✅                     | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ✅ (OpenInference)  | ⚠️ via OTel                                 | ✅ built-in evaluators        | ⚠️                          | ~10,000                                       | **Elastic License 2.0 (not OSI)**                    | active 2026                                  |
| **Comet Opik** (comet-ml/opik)                      | ✅ full platform   | ✅                                           | ✅                     | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ✅                  | ⚠️ via OTel                                 | ✅ LLM-judge, optimizer       | ⚠️                          | ~20,000                                       | Apache-2.0 (no gating)                               | active 2026                                  |
| **OpenLIT** (openlit/openlit)                       | ✅                 | ✅                                           | ✅                     | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ✅                  | ⚠️ via OTel                                 | ✅                            | ❌                           | ~2,300                                        | Apache-2.0                                           | active 2026                                  |
| **Helicone** (Helicone/helicone)                    | ✅                 | ✅                                           | ✅                     | ⚠️ Anthropic-aware  | ⚠️                     | ⚠️                | ❌                  | ⚠️                 | ⚠️ proxy                                    | ✅                            | ⚠️                          | ~5,700                                        | Apache-2.0                                           | active 2026 (some sources: maintenance mode) |
| **Lunary** (lunary-ai/lunary)                       | ✅                 | ✅                                           | ✅                     | ❌                   | ⚠️                     | ⚠️                | ❌                  | ⚠️                 | ⚠️                                          | ✅                            | ⚠️                          | ~1,400                                        | Apache-2.0                                           | active 2026                                  |
| **Laminar** (lmnr-ai/lmnr)                          | ✅                 | ✅                                           | ✅                     | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ✅                  | ⚠️ via OTel                                 | ✅                            | ✅ annotations               | ~2,500                                        | Apache-2.0                                           | active 2026                                  |
| **LangWatch** (langwatch/langwatch)                 | ✅ core            | ✅                                           | ✅                     | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ✅                  | ⚠️                                          | ✅                            | ⚠️                          | ~3,000                                        | Apache-2.0 core (`ee/` commercial)                   | active 2026                                  |
| **SigNoz** (SigNoz/signoz)                          | ✅                 | ✅                                           | ✅ (CC dashboard)      | ✅ (CC `type` label) | ✅ (CC events)          | ✅ (CC events)     | ⚠️                 | ✅                  | ✅ CC; Codex/Copilot                         | ❌                            | ❌                           | ~26,900                                       | MIT (except `ee/`)                                   | active 2026                                  |
| **LiteLLM proxy** (BerriAI/litellm)                 | ✅                 | ✅ admin UI                                  | ✅ per-key/model spend | ✅ Anthropic-aware   | ❌                      | ❌                 | ❌                  | ✅ (v2 GenAI conv.) | ✅ routes all agents                         | ❌                            | ❌                           | ~54,900                                       | MIT (except `enterprise/`)                           | active 2026                                  |
| **Portkey Gateway** (Portkey-AI/gateway)            | ✅ gateway+console | ⚠️ basic console OSS; rich dashboard hosted | ✅                     | ✅                   | ❌                      | ❌                 | ❌                  | ⚠️                 | ✅ routes agents                             | ❌                            | ❌                           | ~12,000                                       | MIT (analytics UI hosted/paywalled)                  | active 2026                                  |
| **OpenLLMetry** (traceloop/openllmetry)             | ✅ lib only        | ❌ needs backend                             | ✅ attributes          | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ✅                  | ⚠️                                          | ❌                            | ❌                           | ~6,100                                        | Apache-2.0                                           | active 2026                                  |
| **Grafana+Prometheus+Loki** (via claude-code-otel)  | ✅                 | ✅                                           | ✅                     | ✅ CC metric         | ✅ Loki events          | ✅                 | ⚠️                 | ✅                  | ✅ CC native; others via OTel                | ❌                            | ❌                           | 300–420 (glue repo)                           | MIT glue; Grafana AGPL/Prom Apache                   | active 2025                                  |
| **ccusage** (ryoppippi/ccusage)                     | ✅                 | ⚠️ TUI/CLI                                  | ✅ per-model, offline  | ✅ from JSONL        | ⚠️                     | ⚠️                | ❌                  | ❌                  | CC + Codex                                  | ❌                            | ❌                           | ~17,200                                       | MIT                                                  | active 2026                                  |
| **Claude-Code-Usage-Monitor** (Maciek-roboblog)     | ✅                 | ⚠️ Rich TUI                                 | ✅                     | ✅                   | ❌                      | ❌                 | ❌                  | ❌                  | CC                                          | ❌                            | ❌                           | ~8,200                                        | MIT                                                  | active 2026                                  |
| **sniffly** (chiphuyen/sniffly)                     | ✅                 | ✅ web :8081                                 | ✅                     | ✅                   | ✅ error/tool breakdown | ✅                 | ⚠️                 | ❌                  | CC                                          | ❌                            | ❌                           | ~1,200                                        | MIT                                                  | active 2025                                  |
| **agenttrace** (luoyuctl/agenttrace)                | ✅                 | ⚠️ TUI + reports + CI gates                 | ✅                     | ✅                   | ✅                      | ✅                 | ⚠️                 | ❌                  | CC/Codex/Gemini/Cline/Aider/Cursor +        | ❌                            | ❌                           | newer/low                                     | see repo                                             | active 2026                                  |
| **TokenTelemetry** (VasiHemanth/tokentelemetry)     | ✅                 | ✅ dashboard                                 | ✅                     | ✅                   | ✅                      | ⚠️                | ❌                  | ❌                  | 13 agents                                   | ❌                            | ❌                           | newer/low                                     | MIT                                                  | active 2026                                  |
| **Inspect AI** (UKGovernmentBEIS/inspect_ai)        | ✅                 | ✅ Inspect View                              | ✅ per-model in logs   | ⚠️                  | ✅ tool events          | ✅                 | ⚠️                 | ⚠️                 | ✅ drives CC/Codex/Gemini as external agents | ✅ 200+ evals, epochs         | ⚠️ transcript review        | ~2,300                                        | MIT                                                  | active 2026                                  |
| **promptfoo** (promptfoo/promptfoo)                 | ✅                 | ✅ web matrix                                | ✅                     | ⚠️                  | ⚠️                     | ⚠️                | ❌                  | ❌                  | ⚠️ providers                                | ✅ YAML side-by-side          | ⚠️                          | ~23,000                                       | MIT (OpenAI-owned)                                   | active 2026                                  |
| **DeepEval** (confident-ai/deepeval)                | ✅                 | ⚠️ Confident cloud for UI                   | ⚠️                    | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ❌                                           | ✅ pytest metrics             | ❌                           | ~16,000                                       | Apache-2.0                                           | active 2026                                  |
| **SWE-bench** (princeton-nlp/SWE-bench)             | ✅                 | ❌ harness                                   | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ⚠️ agent-agnostic patches                   | ✅ pass/fail oracle           | ❌                           | ~3,200                                        | MIT                                                  | active 2026                                  |
| **Label Studio** (HumanSignal/label-studio)         | ✅ Community       | ✅                                           | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ❌                                           | ✅ **pairwise/RLHF template** | ~27,700                     | Apache-2.0 (agreement metrics = Enterprise $) | active 2026                                          |
| **Argilla** (argilla-io/argilla)                    | ✅                 | ✅                                           | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ❌                                           | ✅ feedback/DPO               | ~4,700                      | Apache-2.0 (maintenance slowed)               | slowed                                               |
| **Apache DevLake** (apache/incubator-devlake)       | ✅                 | ✅ Grafana                                   | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ❌ (DORA from Git/CI)                        | ⚠️ review rounds via GitHub  | ❌                           | ~3,000                                        | Apache-2.0                                           | active 2026                                  |
| **reviewdog** (reviewdog/reviewdog)                 | ✅                 | ⚠️ PR comments                              | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ❌                                           | n/a CI gate                  | n/a                         | ~9,400                                        | MIT                                                  | active 2026                                  |
| **PR-Agent** (qodo-ai/pr-agent)                     | ✅ self-host       | ⚠️ PR comments                              | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | ❌                                           | n/a                          | n/a                         | ~12,000                                       | Apache→AGPL→Apache (transitional); Qodo Merge = paid | active 2026                                  |
| **open-model-arena** (pete-builds/open-model-arena) | ✅                 | ✅ web arena                                 | ❌                     | ❌                   | ❌                      | ❌                 | ❌                  | ❌                  | any OpenAI-compat endpoint                  | ⚠️                           | ✅ **blind pairwise + ELO**  | newer/low                                     | see repo                                             | active 2026                                  |
...
| 3  | Rejected edits                                             | **Claude Code OTel** `claude_code.code_edit_tool.decision{decision=reject}` | Built-in metric (CC only); parse JSONL for others                    | ✅ Auto (CC); ⚠️ others                         |
| 4  | Time-to-mergeable                                          | **none direct**                                                             | Manual timestamp (first run → PR you'd merge); or GitHub API on PR   | ❌ Mostly **manual**                            |
| 5  | Review rounds to approve                                   | **Apache DevLake** / GitHub API                                             | GitHub API: count review submissions per PR                          | ✅ Auto (GitHub API)                            |
| 6  | token input (uncached) / model                             | **CC OTel** `claude_code.token.usage{type=input}`; ccusage; LiteLLM         | OTel attribute / JSONL / proxy                                       | ✅ Auto                                         |
| 7  | token output / model                                       | same `{type=output}`                                                        | OTel / JSONL (prefer OTel — JSONL undercounts)                       | ✅ Auto                                         |
| 8  | token cacheCreation / model                                | same `{type=cacheCreation}`                                                 | OTel / JSONL `cache_creation_input_tokens`                           | ✅ Auto (Anthropic-aware only)                  |
| 9  | token cacheRead / model                                    | same `{type=cacheRead}`                                                     | OTel / JSONL `cache_read_input_tokens`                               | ✅ Auto (Anthropic-aware only)                  |
| 10 | Cache hit rate = cacheRead/(input+cacheRead)               | PromQL over `claude_code.token.usage`                                       | Derived metric in Grafana/backend                                    | ✅ Auto (derived)                               |
...
| 18 | API errors / retries                                       | **CC OTel** `api_error` event; LiteLLM                                      | Log event / proxy error counts                                       | ✅ Auto                                         |
| 19 | Wall-clock (reference only)                                | CC `api_request` latency / `active_time`; any backend                       | OTel / timestamps                                                    | ✅ Auto (keep as reference)                     |
| 20 | Build / lint / types / tests green (binary gates)          | **CI + reviewdog**; tsc/mypy/ruff/eslint; pytest                            | CI job exit codes                                                    | ✅ Auto                                         |
| 21 | Diff size (+/− lines, files)                               | `git diff --numstat`; DevLake                                               | Git/CI                                                               | ✅ Auto                                         |
...
| 24 | Hallucinated API (undefined symbols)                       | **compiler/linter** (tsc, mypy, pyflakes, import checks)                    | CI job — count import/compile errors                                 | ✅ Auto                                         |
| 25 | Test-coverage delta on changed lines                       | **diff-cover** + coverage.py/pytest-cov (or pytest_nlcov)                   | CI: coverage.xml vs git diff                                         | ✅ Auto                                         |
| 26 | Cyclomatic-complexity + duplication delta                  | **radon** (Python CC), **lizard** (multi-lang CC), **jscpd** (dup)          | Static analysis, before/after                                        | ✅ Auto                                         |
